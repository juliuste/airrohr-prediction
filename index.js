...
const main = (id) =>
    ...
    .then((res) => {
        ...
        return ({
            'PM10': (res.pm10.mean - dist10.inv(2/3) * res.pm10.stdev * Math.sqrt(1 + (1 / res.pm10.count))),
            'PM2.5': (res.pm25.mean - dist25.inv(2/3) * res.pm25.stdev * Math.sqrt(1 + (1 / res.pm25.count)))
        })
    })
